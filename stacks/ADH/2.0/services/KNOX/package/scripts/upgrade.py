...
def seed_current_data_directory():
  ...
  /usr/adh/2.2.0.0-1234/knox/data -> /var/lib/knox/data
  /usr/adh/2.3.0.0-4567/knox/data -> /var/lib/knox/data-2.3.0.0-4567
  ...
  cp -R -p -f /usr/adh/<old>/knox-server/data/. /usr/adh/current/knox-server/data
  :return:
  """
  import params
