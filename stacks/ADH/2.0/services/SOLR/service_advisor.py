...
class SolrServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommenderDict(self):
    parentRecommendConfDict = super(SolrServiceAdvisor, self).getServiceConfigurationRecommenderDict()
  ...
  def getServiceConfigurationValidators(self):
    parentValidators = super(SolrServiceAdvisor, self).getServiceConfigurationValidators()
    childValidators = {
  ...
  def recommendRangerConfigurations(self, configurations, clusterData, services, hosts):
    super(SolrServiceAdvisor, self).recommendRangerConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendSolrConfigurations(self, configurations, clusterData, services, hosts):
    super(SolrServiceAdvisor, self).recommendSolrConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendHDFSConfigurations(self, configurations, clusterData, services, hosts):
    super(SolrServiceAdvisor, self).recommendHDFSConfigurations(configurations, clusterData, services, hosts)

  def recommendHadoopProxyUsers (self, configurations, services, hosts):
    super(SolrServiceAdvisor, self).recommendHadoopProxyUsers (configurations, services, hosts)
    servicesList = [service["StackServices"]["service_name"] for service in services["services"]]
    users = {}
